...
namespace Blazor7App.Server.Controllers
{
    public class MvcProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProductId,Name,Description,Category,Image,Price")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProductId,Name,Description,Category,Image,Price")] Product product)
        {
